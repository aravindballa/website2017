      ...
      <Paper zDepth={1} className="post">
        ...
        <div className="actions">
          {post.frontmatter.source ?
            (<RaisedButton label="Github" className="btn" onClick={() => handleClick(post.frontmatter.source)} />) :
            (<span />)}
          {post.frontmatter.link ?
            (<RaisedButton label="Open" className="btn" onClick={() => handleClick(post.frontmatter.link)} />) : (<span />)}
