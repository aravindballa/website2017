...
const Footer = () => (
  <div className="text-center text-gray-500 text-xs">
    <p>
      ...
      <a className="text-gray-500" href="https://github.com/aravindballa/website2017" target="_blank">
        opensource
      </a>
      .
      <br />
      ...
      | <a className="text-gray-500" href="https://aravindballa.com/rss.xml">rss</a>
    </p>
  </div>
);
